        ...
        <div className="container max-w-4xl mx-auto px-6">
          <div className="prose prose-slate max-w-none font-body text-gray-700 leading-relaxed space-y-10">
            ...
            <Section title="3. Third-Party Cookies">
              ...
              <p><strong>Google Analytics 4</strong> — we use Google Analytics 4 (GA4, Measurement ID: configured per deployment) to collect anonymised information about how visitors use our website. GA4 uses cookies including <code className="bg-gray-100 px-1 py-0.5 rounded text-xs">_ga</code>, <code className="bg-gray-100 px-1 py-0.5 rounded text-xs">_ga_XXXXXXXXXX</code> to distinguish users and analyse site traffic. We use <strong>Consent Mode v2</strong> — GA4 only collects data after you accept cookies. IP addresses are anonymised. You can opt out at any time by clicking "Decline" on our cookie banner, or by installing the <a href="https://tools.google.com/dlpage/gaoptout" target="_blank" rel="noopener noreferrer" className="text-[#00C8D4] hover:underline">Google Analytics Opt-out Browser Add-on</a>. Google's privacy policy: <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" className="text-[#00C8D4] hover:underline">policies.google.com/privacy</a>.</p>
