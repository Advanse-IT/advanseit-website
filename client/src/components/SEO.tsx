...
export type SEOPage =
  | "home" | "services" | "web-design" | "app-development" | "custom-software"
  | "testing" | "ai-solutions" | "it-staffing" | "about" | "contact"
  | "blog" | "blog-post" | "privacy" | "terms" | "cookies" | "security" | "not-found";
...
const PAGE_META: Record<SEOPage, { title: string; description: string; keywords: string[] }> = {
  home: {
    ...
    keywords: ["AI web development Brisbane", "app development Brisbane", "Brisbane IT company", "AI software development Australia", "custom software development Brisbane", "AI chatbot development Brisbane", "IT staffing Brisbane", "web design Brisbane", "IT services Queensland", "digital transformation Brisbane"],
  },
  services: {
    title: "IT Services Brisbane — Web, App, AI & IT Staffing | AdvanseIT",
    description: "Explore AdvanseIT's full range of IT services: web design, app development, AI solutions, QA testing, and IT staffing across Australia.",
    keywords: ["IT services Brisbane", "web design Brisbane", "app development Brisbane", "AI solutions Australia", "IT staffing Brisbane", "software development Queensland"],
  },
  "web-design": {
    ...
    keywords: ["web design Brisbane", "website development Brisbane", "web development Queensland", "responsive web design Australia", "SEO website Brisbane", "professional website design Brisbane", "React web development Brisbane", "Next.js development Australia"],
  },
  "app-development": {
    ...
    keywords: ["app development Brisbane", "mobile app development Brisbane", "iOS app development Australia", "Android app development Brisbane", "React Native development Brisbane", "cross-platform app development Queensland"],
  },
  "custom-software": {
    ...
    keywords: ["custom software development Brisbane", "bespoke software Brisbane", "enterprise software development Australia", "software solutions Queensland", "tailored software Brisbane"],
  },
  testing: {
    ...
    keywords: ["software testing Brisbane", "QA testing Brisbane", "automated testing Australia", "software quality assurance Brisbane", "test automation Queensland", "performance testing Brisbane"],
  },
  "ai-solutions": {
    ...
    keywords: ["AI solutions Brisbane", "artificial intelligence development Brisbane", "AI integration Australia", "machine learning Brisbane", "AI automation Queensland", "AI consulting Brisbane", "AI-first software Australia"],
  },
  "it-staffing": {
    ...
    keywords: ["IT staffing Brisbane", "IT outsourcing Brisbane", "IT recruitment Australia", "offshore IT staffing Brisbane", "dedicated development team Australia", "IT consulting Brisbane"],
  },
  about: {
    title: "About AdvanseIT — Brisbane IT Company",
    description: "Learn about AdvanseIT, a Brisbane-based IT company delivering cost-effective, AI-first technology solutions to businesses across Australia.",
    keywords: ["AdvanseIT Brisbane", "IT company Brisbane", "technology company Queensland", "Brisbane software company", "Australian IT company"],
  },
  contact: {
    title: "Contact AdvanseIT — Get a Free IT Quote | Brisbane",
    description: "Get in touch with AdvanseIT in Brisbane for a free consultation and project quote. We respond within 24 hours.",
    keywords: ["contact IT company Brisbane", "IT quote Brisbane", "free IT consultation Brisbane", "hire IT company Australia", "IT project quote Queensland"],
  },
  blog: {
    ...
    keywords: ["IT blog Brisbane", "AI insights Australia", "web development tips Brisbane", "app development blog Australia", "IT staffing insights Queensland", "technology blog Brisbane"],
  },
  "blog-post": {
...
export default function SEO({
  ...
  // Direct DOM title update — fixes React 19 duplicate title bug
  useEffect(() => {
  ...
  return (
    <Helmet>
      {/* Title intentionally omitted — set via useEffect above to prevent duplicates */}
      ...
      {isArticle && <meta property="article:publisher" content="https://www.linkedin.com/company/advanseit" />}
